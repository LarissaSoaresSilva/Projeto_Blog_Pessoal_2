        ...
        <div className='border-slate-900 border 
            ...
            <div>
                <div className="flex w-full bg-purple-900 py-2 px-4 items-center gap-4">
                    ...
                    <h3 className='text-purple-200 font-bold text-center uppercase'>
            ...
            <div className="flex">
                <Link to={`/editarpostagem/${postagem.id}`}
                    className='w-full text-purple-200 bg-purple-400
                    hover:bg-purple-600 flex items-center justify-center py-2'>
                    <button>Editar</button>
                </Link>
                <Link to={`/deletarpostagem/${postagem.id}`}
                    className='text-purple-200 bg-red-400 
